...
fuzzycontrolD.insert_rule("M" ,"ML","ML","DF");
fuzzycontrolD.insert_rule("L" ,"ML","ML","DF");
fuzzycontrolD.insert_rule("ML","ML","ML","DF");

fuzzycontrolD.insert_rule("ML","ML","MP","DF");
fuzzycontrolD.insert_rule("ML","ML","P" ,"DF");
fuzzycontrolD.insert_rule("ML","ML","M" ,"DF");
fuzzycontrolD.insert_rule("ML","ML","L" ,"DF");
fuzzycontrolD.insert_rule("ML","ML","ML","DF");

fuzzycontrolD.insert_rule("MP","L","ML","DF");
fuzzycontrolD.insert_rule("P" ,"L","ML","DF");
fuzzycontrolD.insert_rule("M" ,"L","ML","DF");
fuzzycontrolD.insert_rule("L" ,"L","ML","DF");
fuzzycontrolD.insert_rule("ML","L","ML","DF");

fuzzycontrolD.insert_rule("ML","L","MP","DF");
fuzzycontrolD.insert_rule("ML","L","P" ,"DF");
fuzzycontrolD.insert_rule("ML","L","M" ,"DF");
fuzzycontrolD.insert_rule("ML","L","L" ,"DF");
fuzzycontrolD.insert_rule("ML","L","ML","DF");

// Virar para a direita

fuzzycontrolD.insert_rule("MP","M","ML","DT");
fuzzycontrolD.insert_rule("P" ,"M","ML","DT");
fuzzycontrolD.insert_rule("M" ,"M","ML","DT");
fuzzycontrolD.insert_rule("L" ,"M","ML","DT");
fuzzycontrolD.insert_rule("ML","M","ML","DT");

fuzzycontrolD.insert_rule("MP","P","ML","DT");
fuzzycontrolD.insert_rule("P" ,"P","ML","DT");
fuzzycontrolD.insert_rule("M" ,"P","ML","DT");
fuzzycontrolD.insert_rule("L" ,"P","ML","DT");
fuzzycontrolD.insert_rule("ML","P","ML","DT");

fuzzycontrolD.insert_rule("MP","MP","ML","DT");
fuzzycontrolD.insert_rule("P" ,"MP","ML","DT");
fuzzycontrolD.insert_rule("M" ,"MP","ML","DT");
fuzzycontrolD.insert_rule("L" ,"MP","ML","DT");
fuzzycontrolD.insert_rule("ML","MP","ML","DT");
...
fuzzycontrolD.insert_rule("ML","M","MP","DF");
fuzzycontrolD.insert_rule("ML","M","P" ,"DF");
fuzzycontrolD.insert_rule("ML","M","M" ,"DF");
fuzzycontrolD.insert_rule("ML","M","L" ,"DF");
fuzzycontrolD.insert_rule("ML","M","ML","DF");

fuzzycontrolD.insert_rule("ML","P","MP","DF");
fuzzycontrolD.insert_rule("ML","P","P" ,"DF");
fuzzycontrolD.insert_rule("ML","P","M" ,"DF");
fuzzycontrolD.insert_rule("ML","P","L" ,"DF");
fuzzycontrolD.insert_rule("ML","P","ML","DF");

fuzzycontrolD.insert_rule("ML","MP","MP","DF");
fuzzycontrolD.insert_rule("ML","MP","P" ,"DF");
fuzzycontrolD.insert_rule("ML","MP","M" ,"DF");
fuzzycontrolD.insert_rule("ML","MP","L" ,"DF");
fuzzycontrolD.insert_rule("ML","MP","ML","DF");

fuzzycontrolD.insert_rule("MP","ML","ML","DT");
fuzzycontrolD.insert_rule("P","ML","ML","DT");
fuzzycontrolD.insert_rule("M","ML","ML","DT");

// Andar pra trás

// fuzzycontrolD.insert_rule("MP","MP","MP","RT");
// fuzzycontrolD.insert_rule("P","MP","P","RT");
