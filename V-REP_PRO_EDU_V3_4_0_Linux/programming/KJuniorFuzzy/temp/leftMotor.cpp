...
float SumError, ControlOutput;
	...
	cat2[0].setname("ML");
	cat2[0].setrange(0, 400);
	cat2[0].setval(0, 0, 395, 400);

	cat2[1].setname("L");
	cat2[1].setrange(395, 605);
	cat2[1].setval(395, 400, 600, 605);

	cat2[2].setname("M");
	cat2[2].setrange(600, 805);
	cat2[2].setval(600, 605, 800, 805);

	cat2[3].setname("P");
	cat2[3].setrange(800, 900);
	cat2[3].setval(800, 805, 895, 900);

	cat2[4].setname("MP");
	cat2[4].setrange(895, 1000);
	cat2[4].setval(895, 900, 1000, 1000);

	// cat2[0].setname("ML");
	// cat2[0].setrange(990, 1000);
	// cat2[0].setval(980, 990, 1000, 1000);

	// cat2[1].setname("L");
	// cat2[1].setrange(960, 990);
	// cat2[1].setval(960, 970, 980, 990);

	// cat2[2].setname("M");
	// cat2[2].setrange(890, 970);
	// cat2[2].setval(890, 900, 960, 970);

	// cat2[3].setname("P");
	// cat2[3].setrange(800, 900);
	// cat2[3].setval(800, 810, 890, 900);

	// cat2[4].setname("MP");
	// cat2[4].setrange(0, 810);
	// cat2[4].setval(0, 0, 800, 810);
	...
	cat2[5].setname("ML");
	cat2[5].setrange(0, 400);
	cat2[5].setval(0, 0, 395, 400);

	cat2[6].setname("L");
	cat2[6].setrange(395, 605);
	cat2[6].setval(395, 400, 600, 605);

	cat2[7].setname("M");
	cat2[7].setrange(600, 805);
	cat2[7].setval(600, 605, 800, 805);

	cat2[8].setname("P");
	cat2[8].setrange(800, 900);
	cat2[8].setval(800, 805, 895, 900);

	cat2[9].setname("MP");
	cat2[9].setrange(895, 1000);
	cat2[9].setval(895, 900, 1000, 1000);

	// cat2[5].setname("ML");
	// cat2[5].setrange(990, 1000);
	// cat2[5].setval(980, 990, 1000, 1000);

	// cat2[6].setname("L");
	// cat2[6].setrange(960, 990);
	// cat2[6].setval(960, 970, 980, 990);

	// cat2[7].setname("M");
	// cat2[7].setrange(890, 970);
	// cat2[7].setval(890, 900, 960, 970);

	// cat2[8].setname("P");
	// cat2[8].setrange(800, 900);
	// cat2[8].setval(800, 810, 890, 900);

	// cat2[9].setname("MP");
	// cat2[9].setrange(0, 810);
	// cat2[9].setval(0, 0, 800, 810);
	...
	cat2[10].setname("ML");
	cat2[10].setrange(0, 400);
	cat2[10].setval(0, 0, 395, 400);

	cat2[11].setname("L");
	cat2[11].setrange(395, 605);
	cat2[11].setval(395, 400, 600, 605);

	cat2[12].setname("M");
	cat2[12].setrange(600, 805);
	cat2[12].setval(600, 605, 800, 805);

	cat2[13].setname("P");
	cat2[13].setrange(800, 900);
	cat2[13].setval(800, 805, 895, 900);

	cat2[14].setname("MP");
	cat2[14].setrange(895, 1000);
	cat2[14].setval(895, 900, 1000, 1000);

	// cat2[10].setname("ML");
	// cat2[10].setrange(990, 1000);
	// cat2[10].setval(980, 990, 1000, 1000);

	// cat2[11].setname("L");
	// cat2[11].setrange(960, 990);
	// cat2[11].setval(960, 970, 980, 990);

	// cat2[12].setname("M");
	// cat2[12].setrange(890, 970);
	// cat2[12].setval(890, 900, 960, 970);

	// cat2[13].setname("P");
	// cat2[13].setrange(800, 900);
	// cat2[13].setval(800, 810, 890, 900);

	// cat2[14].setname("MP");
	// cat2[14].setrange(0, 810);
	// cat2[14].setval(0, 0, 800, 810);
